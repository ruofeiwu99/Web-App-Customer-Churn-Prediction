...
from src.modeling import train_model, make_predictions, eval_performance, \
    save_model, save_train_test, save_model_eval
...
if __name__ == '__main__':
    ...
    parser.add_argument('step', help='Which step to run',
                        choices=['upload_data', 'acquire_data', 'clean_data',
                                 'create_db', 'ingest_data', 'train_model',
    ...
    parser.add_argument('--local_data_path', default='data/external/raw_data.csv',
                        help='Local data path to upload data to s3')

    parser.add_argument('--raw_data_dir', default='data/raw',
                        help='Path to save raw data downloaded from s3')

    parser.add_argument('--cleaned_data_dir', default='data/final',
                        help='Directory to save cleaned data')

    parser.add_argument('--engine_string', default=SQLALCHEMY_DATABASE_URI,
                        help='SQLAlchemy connection URI for database')

    parser.add_argument('--input_path', default='data/final/final_data.csv',
                        help='File path for data to be loaded into the database')

    parser.add_argument('--model_dir', default='models',
                        help='Directory to save trained model object')

    parser.add_argument('--X_train_dir', default='models',
                        help='Directory to save features from training data')

    parser.add_argument('--X_test_dir', default='models',
                        help='Directory to save target column from training data')

    parser.add_argument('--y_train_dir', default='models',
                        help='Directory to save features from test data')

    parser.add_argument('--y_test_dir', default='models',
                        help='Directory to save target column from test data')

    parser.add_argument('--pred_result_dir', default='models',
                        help='Directory to save prediction results')

    # specify directory to save model evaluation results
    parser.add_argument('--model_eval_dir', default='models',
